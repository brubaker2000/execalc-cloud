...
| Capability | Stack | Runtime Object | Enforcement Location | Audit Signal | Test Coverage | Status |
|---|---|---|---|---|---|---|
| Prime Directive | Core 7 | DecisionArtifact | Decision loop before output emission | Decision artifact fields and audit payload | Pending | Open |
...
| Polymorphia | Core 7 | Scenario / DecisionArtifact actor and incentive structures | Multi-actor analysis stage for relevant scenarios | Actor and incentive data in runtime output | Pending | Open |
